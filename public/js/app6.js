...
faq.forEach(function (item, index, arr) {
    item.addEventListener('click', function () {
        ...
        if (testNumber == 9) {
            ...
            <p id="text-base" class="text-black md:text-3xl mb-4 text-xl font-bold capitalize">Darajangiz PROFICIENCY Emas 🤥</p >
            ...
            <p id="text-base" class="text-black md:text-3xl mb-5 text-xl font-bold capitalize">Darajangiz PROFICIENCY 😎</p >
            <div class="pl-2.5 text-center mt-4">
                <a href="index.html"
                    class="py-2 px-5 bg-[#0b58a7] text-white rounded-2xl cursor-pointer transition-all hover:bg-[#064484]"
                    >Bosh Saxifaga</a>
